...
def _upsert_row(asset: dict[str, Any], connection) -> None:
    ...
    values = {
        ...
        "health_state": _text(asset.get("health") or asset.get("healthState") or "unknown"),
        "connectivity_state": _text(asset.get("connectivity") or asset.get("connectivityState") or "unknown"),
