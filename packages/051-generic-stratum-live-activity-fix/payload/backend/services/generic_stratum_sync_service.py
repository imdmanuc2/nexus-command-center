...
def synchronize_generic_stratum_inventory() -> dict[str, Any]:
    ...
    for configured in configured_pools:
        ...
        for worker_config in configured_workers:
            ...
            # acceptedShares is cumulative historical data and must never
            # prove that a worker is connected now. Only a live connection,
            # measurable current telemetry, or a timestamped recent share is
            # authoritative for current activity.
            recent_share = bool(
