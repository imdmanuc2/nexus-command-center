...
grep -q "ast.parse" "$PKG_DIR/backend/api/install_change_rollback_routes.py"
grep -q "installed and verified" "$PKG_DIR/backend/api/install_change_rollback_routes.py"
