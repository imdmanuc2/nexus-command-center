...
def synchronize_generic_stratum_inventory() -> dict[str, Any]:
    ...
    for configured in configured_pools:
        ...
        for worker_config in configured_workers:
            ...
            # Live CKPool telemetry is authoritative for current activity.
            # The configured active flag is an operator preference/default and
            # must not suppress a worker that is demonstrably submitting shares.
            worker_online = bool(
                pool_online
                and live_activity
            )
